...
import sss.openstar.message.serialize.MsgResponseSerializer
import sss.openstar.message.{EndMessageQuery => EndMessageQueryObj}
import sss.openstar.message.{EndMessagePage => EndMessagePageObj}
