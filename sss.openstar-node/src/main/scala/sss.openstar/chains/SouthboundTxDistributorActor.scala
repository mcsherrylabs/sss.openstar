...
import sss.openstar.block.{BlockChain, BlockChainLedger, BlockChainSignatures, BlockChainSignaturesAccessor, BlockClosedEvent, DistributeClose, NotSynchronized}
...
import sss.openstar.ledger.{LedgerItem, Ledgers}
...
object SouthboundTxDistributorActor {
  ...
  case class SouthboundRejectedTx(blockChainTxId: BlockChainTxId) extends OpenstarEvent
  case class SouthboundTx(blockChainTx: BlockChainTx) extends OpenstarEvent
  case class SouthboundClose(close: DistributeClose) extends OpenstarEvent

  case class SynchronizedConnection(chainId: GlobalChainIdMask, nodeId: UniqueNodeIdentifier) extends OpenstarEvent
