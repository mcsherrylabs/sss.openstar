...
object NobuUI {
  ...
  case class Detach(ui: Int) extends OpenstarEvent
  case class Logout(who: UniqueNodeIdentifier) extends OpenstarEvent

  val SessionAttr = "NOBU"

  case class SessionEnd(str: String)  extends OpenstarEvent
